...
public class JobSeekerController {
    ...
    @GetMapping
    public ResponseEntity<APIResponse<JobSeekerResponsePage>> getAllJobSeekers(@RequestParam(value = "pageNo", defaultValue = AppConstants.DEFAULT_PAGE_NO, required = false) int pageNo,
